...
plot "rho_doppler" u 1:2:3 with yerror pt 7 ps 0.8 lc 6 title "Doppler broadening effect - BoL",\
...
plot "rho_doppler" u 1:4:5 with yerror pt 7 ps 0.8 lc 7 title "Doppler broadening effect - MoL",\
	f(x) lc 8 title sprintf("{/Symbol a}_{fuel} = %.2f ± %.2f", a, a_err) 
...
plot "rho_doppler" u 1:6:7 with yerror pt 7 ps 0.8 lc 12 title "Doppler broadening effect - EoL",\
	f(x) lc 8 title sprintf("{/Symbol a}_{fuel} = %.2f ± %.2f", a, a_err) 
...
plot "DopplerCoefficients" u 1:2 w lp pt 7 ps 0.8 lc 6 title "Doppler coefficient - BoL",\
	"DopplerCoefficients" u 1:3 w lp pt 7 ps 0.8 lc 7 title "Doppler coefficient - MoL",\
		"DopplerCoefficients" u 1:4 w lp pt 7 ps 0.8 lc 9 title "Doppler coefficient - EoL"
...
plot "rho_coolant" u 1:2:3 with yerror pt 7 ps 0.8 lc 6 title "Coolant temperature feedback - BoL",\
f(x) lc 8 notitle 
...
plot "rho_coolant" u 1:4:5 with yerror pt 7 ps 0.8 lc 6 title "Coolant temperature feedback - MoL",\
f(x) lc 8 notitle 
#sprintf("{/Symbol a} = %.2f ± %.2f", a, a_err) 
...
plot "rho_coolant" u 1:6:7 with yerror pt 7 ps 0.8 lc 6 title "Coolant temperature feedback - EoL",\
f(x) lc 8 notitle 
#sprintf("{/Symbol a}  %.2f ± %.2f", a, a_err) 
